...
{
    [Test]
    public void ToByteArray_Primitives_bool()
    {
        Assert.That(
            new[]
            {
                false, true, false, false, true, true, true, true, false, false, true, false, true, false, false,
                false, true, false, false, true, true, true, true, false, false, true, true, false, false, false
            }.ToByteArray(),
            Is.EqualTo(
    ...
    [Test]
    public void ToByteArray_Primitives_sbyte()
    {
        ...
        Assert.That(
            ...
            Is.EqualTo(
                new byte[]
                {
                    ...
                    242, 243, 244, 245, 246, 247, 248, 249, 250, 251, 252, 253, 254, 255, 0, 1, 2, 3, 4, 5, 6, 7, 8,
    ...
    private static IEnumerable ToByteArray_Primitives_char_cases()
    {
    ...
    [TestCaseSource(typeof(ArrayExtensionsTests), nameof(ToByteArray_Primitives_char_cases))]
    public void ToByteArray_Primitives_char(char[] inputArray, byte[] expected)
    {
        Assert.That(inputArray.ToByteArray(), Is.EqualTo(expected));
    }

    [Test]
    public void ToByteArray_Primitives_double()
    {
        Assert.That(
            new[]
            {
    ...
    [Test]
    public void ToByteArray_Primitives_float()
    {
        Assert.That(
            new[]
            {
    ...
    [Test]
    public void ToByteArray_Primitives_short()
    {
        short[] inputArray =
        {
    ...
    [Test]
    public void ToByteArray_Primitives_ushort()
    {
    ...
    [Test]
    public void ToByteArray_Primitives_int()
    {
        int[] inputArray =
        {
        ...
        Assert.That(
            ...
            Is.EqualTo(
                new byte[]
                {
                    0x0, 0x0, 0x0, 0x0, 0xff, 0x0, 0x0, 0x0, 0x0, 0xff, 0x0, 0x0, 0x0, 0x0, 0xff, 0x0, 0x0, 0x0,
                    0x0, 0xff, 0x98, 0xba, 0xdc, 0xfe, 0x0f, 0xf0, 0x0, 0x0, 0x0f, 0x0f, 0xf0, 0x0, 0xf0, 0x0f,
                    0x0f, 0xf0,
                }
            )
        );
    ...
    [Test]
    public void ToByteArray_Primitives_uint()
    {
    ...
    [Test]
    public void ToByteArray_Primitives_long()
    {
        long[] inputArray =
        {
    ...
    [Test]
    public void ToByteArray_Primitives_ulong()
    {
        ulong[] inputArray =
        {
            0x0, 0xf, 0xf0, 0xf00, 0xf000, 0xf0000, 0xf00000, 0xf000000, 0xf0000000, 0xf00000000, 0xf000000000,
